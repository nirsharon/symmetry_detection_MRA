function [new_D] = visual_sequential_rejection_DAG(G, nodes_info, to_save)
...
plot_the_hasse_diagram_reject(G, nodes_info, D, 0, to_save);
...
while counter<max_count
    ...
    plot_the_hasse_diagram_reject(G, nodes_info, new_D, counter, to_save)
